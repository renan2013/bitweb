...
export default {
  ...
  es: {
    ...
    CardColors: 'Tarjeta de Colores',
    Table: 'Tabla',
    agGridTable: 'Tabla con Rejilla',
    Components: 'Componentes',
    Alert: 'Alerta',
    Avatar: 'Avatar',
    Badge: 'Indiginia',
    ...
    Tabs: 'Pestañas',
    Tooltip: 'Información sobre',
    Upload: 'Subir',
    FormsAndTable: 'Formularios y tabla',
    ...
    FormInputGroup: 'Grupo de entrada dde Formulario',
    Pages: 'Páginas',
    Authentication: 'Autenticación',
    Login: 'Login',
    Register: 'Registro',
    ForgotPassword: 'Olvido su Contraseña',
    ResetPassword: 'Resetear su Contraseña',
    ...
    ContextMenu: 'Menu Contextual',
    StarRatings: 'Clasificación por Estrellas',
    Autocomplete: 'Autocompletar',
    Tree: 'Arbol',
    // "Import/Export": 'Importar/Exportar',
    Import: 'Importar',
    ...
    DisabledMenu: 'Menu desactivado',
    Support: 'Soporte',
    Documentation: 'Documentación',
    RaiseSupport: 'Aumento de Soporte',
    demoTitle: 'Título de demostración',
    demoText: 'O sésamo do bolo agarra dinamarquês do pão-de-espécie do queque eu amo o pão-de-espécie. Torta de torta de maçã jujuba chupa chups muffin halvah pirulito. Ameixa do açúcar do maçapão do tiramisu do bolo da aveia do bolo de chocolate. Bolo de aveia de torta doce rosquinha dragée fruitcake algodão doce gotas de limão.'
  }
}
