  ...
  <div class="contenedor" id="tletra">
    ...
    <div class="vx-row">
      <div class="vx-col sm:w-1/2 w-full mb-2">
        <vs-input
          class="w-full"
          label-placeholder="Título de la Publicación"
    ...
    <div class="vx-row">
      <div class="vx-col sm:w-full mb-2">
        <vs-textarea
          label="Síntesis de la Publicación - Breve"
          v-model="publicacion.detalle"
        />
      </div>
    ...
    <div class="vx-row">
      <div
        class="vx-col md:w-1/4 w-full mt-2"
        v-show="indicadorDML == 'U' || indicadorDML == 'I' || true"
      >
    ...
    <div class="vx-row" id="botones">
      <div class="vx-col w-full">
        <vs-button class="mr-3 mb-2" @click="GuardaRegistro()"
          >Enviar</vs-button
        >

        <vs-button color="warning" type="border" class="mb-2" @click="test()"
          >Reset</vs-button
        >
      </div>
    </div>
