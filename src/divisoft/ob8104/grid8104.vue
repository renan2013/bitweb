...
<template>
  <div>
   ...
   <table class="table">   
     ...
     <filtrosDivisoft v-show="activaFiltro" :header="locallastheader"  :isSidebarActive="activaFiltro" :filas="locallaststrFilas" :filtros="filtros"  :ObjectID=8104   @closeSidebar="activaFiltro = false" 
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos8104.columnDefs;
        var defaultdatos = datos8104.datosDefault;
