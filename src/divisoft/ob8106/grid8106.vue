...
<template>
  <div>
   ...
   <table class="table">   
     ...
     <filtrosDivisoft v-show="activaFiltro" :header="locallastheader"  :isSidebarActive="activaFiltro" :filas="locallaststrFilas" :filtros="filtros"  :ObjectID=8106   @closeSidebar="activaFiltro = false" 
...
import * as datos8106 from "./js/divi8106.js";
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos8106.columnDefs;
        var defaultdatos = datos8106.datosDefault;
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            ...
            this.dinamicKey = [];
 this.dinamicKey.push({ nombre: "ID_USUARIO", valor: event.node.data.ID_USUARIO });
 this.dinamicKey.push({ nombre: "ID_ROL", valor: event.node.data.ID_ROL });
      ...
      // addFilas Gen_CAMPOS_GRID(1)
            addFilas: function() {
            var filas = [];
 filas.push({ NOMBRE: "ID_USUARIO", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 filas.push({ NOMBRE: "ID_ROL", VALOR1: "", VALOR2: "", CDATA: "0" }); 
 filas.push({ NOMBRE: "NUM_EMPRESA", VALOR1: "", VALOR2: "", CDATA: "0" }); 
        ...
        //LLAMA AL COMPONENTE EDIT PARA  AGREGAR UN REGISTRO NUEVO
         // RegistroNuevo Gen_CAMPOS_GRID(3)
            RegistroNuevo() {
                    ...
                    this.$store.commit("mutsetDatosDefault", defaultdatos);
                    //LLAVES
  this.dinamicKey.push({ nombre: "ID_USUARIO", valor: "0" }); 
  this.dinamicKey.push({ nombre: "ID_ROL", valor: "0" }); 
   //llama método editar registro
            eventBus.$emit("cargaRegistro", this.dinamicKey);
