...
<template>
  <div>
   ...
   <table class="table">   
     ...
     <filtrosDivisoft v-show="activaFiltro" :header="locallastheader"  :isSidebarActive="activaFiltro" :filas="locallaststrFilas" :filtros="filtros"  :ObjectID=8102   @closeSidebar="activaFiltro = false" 
...
import * as datos8102 from "./js/divi8102.js";
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos8102.columnDefs;
        var defaultdatos = datos8102.datosDefault;
    ...
    methods: {
        ...
        onDoubleClicked(event) {
            ...
            this.dinamicKey = [];
 this.dinamicKey.push({ nombre: "NUM_EMPRESA", valor: event.node.data.NUM_EMPRESA });
      ...
      // addFilas Gen_CAMPOS_GRID(1)
            addFilas: function() {
            var filas = [];
 filas.push({ NOMBRE: "NOMBRE_USUARIO", VALOR1: "", VALOR2: "", CDATA: "0" }); 
        ...
        //LLAMA AL COMPONENTE EDIT PARA  AGREGAR UN REGISTRO NUEVO
         // RegistroNuevo Gen_CAMPOS_GRID(3)
            RegistroNuevo() {
                    ...
                    this.$store.commit("mutsetDatosDefault", defaultdatos);
                    //LLAVES
  this.dinamicKey.push({ nombre: "NUM_EMPRESA", valor: "0" }); 
   //llama método editar registro
            eventBus.$emit("cargaRegistro", this.dinamicKey);
