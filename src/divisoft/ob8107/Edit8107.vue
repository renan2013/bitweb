...
<template>
  ...
  <vx-card :title="getAction" code-toggler>
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new pt-4 pb-6"> 
      ...
      <p>Descripcion</p>
        <vs-input size="large" v-validate="'required'"    name="DESCRIPCION" v-model="DESCRIPCION" class="mt-5 w-full" />
         
        <span class="text-danger">{{errors.first("step-1.DESCRIPCION")}}</span>
...
import * as datos8107 from "./js/divi8107.js";
...
const dict = datos8107.mensajesValidacion;
...
export default {
  ...
  beforeMount() {
    ...
    this.defaultdatos = datos8107.datosDefault;
   ...
   data() {
    return {
      ...
      // CMS CMS CMS CMS          DatOS cms Para manejo de EXPEDIENTE DIGITAL  MULTIMEDIA Debe venir en una funcion de Datos con la consulta
        // CMSDATA8107: datos8107.CMSDATA8107,  PROPSDataCMS: divilib.DataCMS,  tituloAvatar: "Para Cambiar Avatar",  verDocumento1: false,
  ...
  watch: { 
   ...
   lastBdmsgcode:function(){
    ...
    "rowsForm": function() {
      if (this.rowsForm[0].NUM_PUBLICACION > "0")
 ...
 validateStep3() {
    ...
    // FIN DE VALIDA PASOS ESTO SI ES UN FORMULARIO DE PASOS 
     ...
     addFilas: function() {
            var filas = [];
                                  ...
                                  filas.push({
                                    NOMBRE: "COMENTARIOS",
                                    VALOR1: this.COMENTARIOS,
                                    VALOR2: "9999999999",
                                    CDATA: "0"
                                  }); 
                                  filas.push({
                                    NOMBRE: "RUTA_CREAR_ARCHIVO",
                                    VALOR1: this.RUTA_CREAR_ARCHIVO,
                                    VALOR2: "",
                                    CDATA: "0"
                                  }); 
                                  filas.push({
                                    NOMBRE: "NOMBRE_ARCHIVO",
                                    VALOR1: this.NOMBRE_ARCHIVO,
                                    VALOR2: "",
                                    CDATA: "0"
                                  }); 
                                  filas.push({
                                    NOMBRE: "LANGUAGE_CODE",
                                    VALOR1: this.LANGUAGE_CODE,
                                    VALOR2: "",
                                    CDATA: "0"
                                  }); 
                                  filas.push({
                                    NOMBRE: "TEMPLATE_EXTRA",
                                    VALOR1: this.TEMPLATE_EXTRA,
                                    VALOR2: "",
                                    CDATA: "0"
                                  }); 
                                  filas.push({
   ...
   /////////// GUARDA DATOS GUARDA DATOS  GUARDA DATOS  GUARDA DATOS   ////////////      
    ...
    // CARGA DE una variable Bd a DOM
     cargaRegistroActual: function(datosRow) { 
          this.NUM_PUBLICACION = datosRow.NUM_PUBLICACION;
          this.LLAVE = datosRow.LLAVE;
          ...
          this.FAMILIA = datosRow.FAMILIA;
          this.NIVEL = datosRow.NIVEL;
          this.PRECIO = datosRow.PRECIO;
          this.TITULO = datosRow.TITULO;
          this.CONTENIDO = datosRow.CONTENIDO;
          this.AUTOR = datosRow.AUTOR;
          this.ESTADO = datosRow.ESTADO;
          this.FECHA = datosRow.FECHA;
          this.TAGS = datosRow.TAGS;
          this.LECTURAS = datosRow.LECTURAS;
          this.ACTCOM = datosRow.ACTCOM;
          this.PORTADA = datosRow.PORTADA;
          this.COMENTARIOS = datosRow.COMENTARIOS;
          this.RUTA_CREAR_ARCHIVO = datosRow.RUTA_CREAR_ARCHIVO;
          this.NOMBRE_ARCHIVO = datosRow.NOMBRE_ARCHIVO;
          this.LANGUAGE_CODE = datosRow.LANGUAGE_CODE;
          this.TEMPLATE_EXTRA = datosRow.TEMPLATE_EXTRA;
   ...
   //cargaRegistroActual funcion completa   
    ...
    buscarRegistro: function(dinamicKey) {
      ...
      var origenUrl = "O";
       // agrego las filas
         var filas = datos8107.getMisFilas();
