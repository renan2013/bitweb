...
<template>
  <div>
   ...
   <table class="table">   
     ...
     <filtrosDivisoft v-show="activaFiltro" :header="locallastheader"  :isSidebarActive="activaFiltro" :filas="locallaststrFilas" :filtros="filtros"  :ObjectID=8103   @closeSidebar="activaFiltro = false" 
...
import * as datos8103 from "./js/divi8103.js";
...
export default {
    ...
    beforeMount() {
        ...
        this.columnDefs = datos8103.columnDefs;
        var defaultdatos = datos8103.datosDefault;
