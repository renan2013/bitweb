    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new pt-4 pb-6"> 
        <vx-input-group class="mb-base">
            <div class="vx-row"> 
                                 ...
                                 <p>Idadm Tags</p>
                                <vs-input size="large" name="IDADM_TAGS" v-model="IDADM_TAGS" class="mt-5 w-full" />
                                <span class="text-danger">{{errors.first("step-1.IDADM_TAGS")}}</span>
                              </div><div class="vx-col w-1/2">
        <vs-input size="large"    label="Nombre" name="NOMBRE" v-model="NOMBRE" class="mt-5 w-full" /> 
      </div><div class="vx-col w-1/2">
        <vs-input size="large"    label="Descripcion" name="DESCRIPCION" v-model="DESCRIPCION" class="mt-5 w-full" /> 
      </div> 
                                 <div class="vx-col md:w-1/2 w-full">
                                 <p>Num Empresa</p>
...
const dict = datos8108.mensajesValidacion;
...
export default {
  ...
  beforeMount() {
    ...
    this.defaultdatos = datos8108.datosDefault;
   ...
   data() {
    return {
      ...
      // CMS CMS CMS CMS          DatOS cms Para manejo de EXPEDIENTE DIGITAL  MULTIMEDIA Debe venir en una funcion de Datos con la consulta
        // CMSDATA8108: datos8108.CMSDATA8108,  PROPSDataCMS: divilib.DataCMS,  tituloAvatar: "Para Cambiar Avatar",  verDocumento1: false,
  ...
  watch: { 
   ...
   lastBdmsgcode:function(){
    ...
    "rowsForm": function() {
      if (this.rowsForm[0].IDADM_TAGS > "0")
 ...
 validateStep3() {
   ...
   /////////// GUARDA DATOS GUARDA DATOS  GUARDA DATOS  GUARDA DATOS   ////////////      
    ...
    // CARGA DE una variable Bd a DOM
     cargaRegistroActual: function(datosRow) { 
          this.IDADM_TAGS = datosRow.IDADM_TAGS;
   ...
   //cargaRegistroActual funcion completa   
    ...
    buscarRegistro: function(dinamicKey) {
      ...
      var origenUrl = "O";
       // agrego las filas
         var filas = datos8108.getMisFilas();
