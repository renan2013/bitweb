...
<div id="data-list-list-view" class="vx-col md:w-1/2 w-full mb-base">
    ...
    <VuePerfectScrollbar class="scroll-area--data-list-add-new pt-4 pb-6">
            ...
            <div class="vx-row"> 
                <div class="vx-col sm:w-2/3 w-full mb-2">
                    <vs-list> 
                        ...
                        <vs-list-item icon-pack="feather" :key="indextr" v-for="(item, indextr) in CMSDataRespuesta" icon="icon-check" :subtitle="item.referencia">
                       
                             <img   style="display:block; width:100px;height:100px;"  :src="item.ruta" />
                        </vs-list-item>
        ...
        <br>
        <button type="submit" class="boton_adjuntar" @click="pruebaArchivo()">prueba</button>
    </VuePerfectScrollbar>
